...
"use strict";
    ...
    var DSLHighlightRules = function() {
        ...
        "return|switch|while|catch|operator|try|throw|using|Export|SendEmail|function"
    );
    
    var storageType = (
        "asm|__asm__|auto|bool|_Bool|char|_Complex|double|enum|float|" +
        "_Imaginary|int|long|short|signed|struct|typedef|union|unsigned|void|" +
        "class|wchar_t|template|char16_t|char32_t|action|Dashboard|Collection|Document|" +
        "row|Cell|action|column|index"
    );

    var storageModifiers = (
        "const|extern|register|restrict|static|volatile|inline|private|" +
        "protected|public|friend|explicit|virtual|mutable|typename|" +
    ...
    var properties = (
        "columnLabel|id|label|name|order|query|sortby|table|type|transformation|value|Weight|" +
