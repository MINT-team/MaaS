...
var PersonalData = React.createClass({
  ...
  _onSubmit: function(event) {
      ...
      if( name!=this.state.name || surname!=this.state.surname || gender!=this.state.gender
                                || (!dateOfBirth && getDateOfBirth(this.state.dateOfBirth)!="NaN-NaN-NaN")
                                || (dateOfBirth && dateOfBirth!=getDateOfBirth(this.state.dateOfBirth)) ) 
      {
